    ...
    try {
      ...
      if (summary.status === "completed") {
        ...
        if (pages.length > 0) {
          ...
          // Create page audits - ensure all integer fields are properly typed
          const auditRecords = pages.map(page => ({
            ...
            titleLength: typeof page.meta.titleLength === 'number' ? page.meta.titleLength : null,
            description: page.meta.description,
            descriptionLength: typeof page.meta.descriptionLength === 'number' ? page.meta.descriptionLength : null,
            canonicalUrl: page.meta.canonicalUrl,
            isIndexable: page.indexability.isIndexable,
            indexabilityReason: page.indexability.reason,
            wordCount: typeof page.content.wordCount === 'number' ? page.content.wordCount : 0,
            h1Count: typeof page.content.h1Count === 'number' ? page.content.h1Count : 0,
            h2Count: typeof page.content.h2Count === 'number' ? page.content.h2Count : 0,
            ...
            loadTimeMs: typeof page.performance.loadTimeMs === 'number' ? page.performance.loadTimeMs : null,
            lcpMs: typeof page.performance.lcpMs === 'number' ? page.performance.lcpMs : null,
            clsScore: page.performance.clsScore ? String(page.performance.clsScore) : null,
            tbtMs: typeof page.performance.tbtMs === 'number' ? page.performance.tbtMs : null,
            fidMs: typeof page.performance.fidMs === 'number' ? page.performance.fidMs : null,
            internalLinksCount: typeof page.links.internalCount === 'number' ? page.links.internalCount : 0,
            externalLinksCount: typeof page.links.externalCount === 'number' ? page.links.externalCount : 0,
            brokenLinksCount: typeof page.links.brokenCount === 'number' ? page.links.brokenCount : 0,
            imagesCount: typeof page.images.count === 'number' ? page.images.count : 0,
            imagesWithoutAlt: typeof page.images.withoutAlt === 'number' ? page.images.withoutAlt : 0,
            hasSchema: page.schema.hasSchema,
            schemaTypes: page.schema.types,
            clickDepth: typeof page.structure.clickDepth === 'number' ? page.structure.clickDepth : null,
